...
import { purchasesOverviewList } from './PurchasesOverviewConfig';
...
class PurchasesOverview extends Component {
  constructor(props) {
    super(props);
    this.state = {
      pageNo: 0,
  ...
  render() {
    ...
    const columns = nameColumn.concat(purchasesOverviewList.columns);
    // .concat(actionColumn);
    return (
      <div>
        <BackdropLoader open={this.state.loader} />
        <div className='purchasesaction'>
          <div className='purchasesactionfirst'>
            <Button
              className={
          ...
          <div className='purchasesactionSecond'>
        ...
        {this.state.listData && (
          <div className='purchasesOverviewTable DashboardPurchasesTable'>
            <NewReactTableComponent
              listData={this.state.listData}
              listConfig={purchasesOverviewList}
              columns={columns}
        ...
        >
          ...
          <DialogContent>
            <div className='documentflex'>
              <div className='salesquesiton' onClick={() => this.onChooseDocumentClick('salesQuotation')}>
                <svg
              ...
              <div className='paymentCertificate' onClick={() => this.onChooseDocumentClick('paymentCertificate')}>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  width='22.278'
                  height='21.081'
              ...
              <div className='invoice' onClick={() => this.onChooseDocumentClick('invoice')}>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  width='19.922'
                  height='20'
...
export default withRouter(PurchasesOverview);
