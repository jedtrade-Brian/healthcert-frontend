...
export class PDDMCSTemplate extends Component {
    constructor (props) {
        super(props);
    }
            ...
            <>
                <div className='p-2 container'>
                    <div style={contentStyles}>
                        ...
                        <h1 style={{color: 'red'}}>PROFESSIONAL DIPLOMA</h1>
                        <h2 style={{color: 'red'}}>in Digital Marketing and Campaign Strategy</h2>
