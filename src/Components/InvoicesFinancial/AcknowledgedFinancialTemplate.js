...
class AcknowledgedFinancialTemplate extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
    ...
    return (
      <div>
        <div className='salesDocumentHead'>
          ...
          <h5>Acknowledged Successfully</h5>
          <ul>
            <li>
              <span>
                Thank you! This NOA has been acknowledged successfully.
              </span>
            </li>
          </ul>
        </div>
        <div className='salesDocumentOrder'>
          ...
          <ul>
            <li>
              ...
              <span>:</span>
              <span>{this.props.data ? this.props.data.docInfo.name : ''}</span>
            </li>
            <li>
              <span>Document Hash</span>
              <span>:</span>
              <span>{this.props.data ? this.props.data.docHash : ''}</span>
            </li>
            <li>
            {/* data.docInfo.issuers[0].name */}
              <span>Created By</span>
              <span>:</span>
              <span>{this.props.data ? this.props.data.docInfo.issuers[0].name : ''}</span>
            </li>
            <li>
              <span>Date & Time</span>
              <span>:</span>
              <span>{this.props.data ? unixTimestampToDate(this.props.data.createdAt) + ' ' + getTimeFromUnixTimestamp(this.props.data.createdAt) : ''}</span>
            </li>
          </ul>
        </div>
      </div>
...
export default AcknowledgedFinancialTemplate;
