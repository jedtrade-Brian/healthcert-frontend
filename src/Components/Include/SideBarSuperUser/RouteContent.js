...
export const routingList = [
  ...
  // },
  {
    ...
    path: "/Settings",
    image: (
        <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" xmlnssvgjs="http://svgjs.com/svgjs" 
          version="1.1" width="24" height="24" viewBox="0 0 24 24" x="0" y="0" viewBox="0 0 512 512" xmlSpace="preserve" >
            <g>
                <g xmlns="http://www.w3.org/2000/svg">
                    <path d="M296,280h-8.8c-3.31,0.006-6.271-2.059-7.408-5.168c-0.976-2.56-2.024-5.064-3.152-7.544
                        ...
                        c3.554,9.281,12.446,15.424,22.384,15.464h8.8c4.418,0,8,3.582,8,8V336z" fill="#fff"/>
                </g>
            </g>
            <g>
                <g xmlns="http://www.w3.org/2000/svg">
                    <path d="M231.84,316.8c-0.08-1.92-0.216-3.832-0.448-5.736c-0.256-2.048-0.56-4.08-0.984-6.072c-0.28-1.304-0.648-2.592-1-3.888
                        ...
                        C215.936,318.336,215.968,320.184,215.896,322.04z" fill="#fff"/>
                </g>
            </g>
            <g>
                <g xmlns="http://www.w3.org/2000/svg">
                    <path d="M456,168h-25.16c-3.355,0.034-6.356-2.079-7.456-5.248c-2.481-7.431-5.483-14.679-8.984-21.688
                        ...
                        C480,178.745,469.255,168,456,168z" fill="#fff"/>
                </g>
            </g>
            <g>
                <g xmlns="http://www.w3.org/2000/svg">
                    <path d="M337.536,142.464c-40.638-40.553-106.434-40.553-147.072,0c-3.069,3.178-2.981,8.243,0.197,11.312
                        ...
                        c0.066-0.064,0.132-0.13,0.196-0.196C378.089,248.898,378.089,183.102,337.536,142.464z" fill="#fff"/>
                </g>
            </g>
        </svg>
    )
