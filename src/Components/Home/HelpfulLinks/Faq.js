          ...
          <div className='container'>
            <div className='row'>
              ...
              <article>
                  ...
                  <h2>What is ConsenTrade?</h2>
                  <p>
                    ConsenTrade is a selected project under IMDA’s blockchain
                    challenge - Growing and Connecting Blockchain Business
                    Network (TradeTrust theme). Adopting TradeTrust’s
                    interoperability framework, ConsenTrade provides a supply
                    chain attestation solution that allow users to issue and
                    attest on the authenticity of digital trade documents (sales
                    quotation, invoice, etc) through a single platform.
                  </p>
                  <br />
                  <h2>Why should I use ConsenTrade?</h2>
                  <p>
                    ConsenTrade improves the current supply chain procedures by
                    implementing blockchain technology and leveraging on the
                    TradeTrust’s framework to ensure sending of trade documents
                    can be authenticated and tampering-proof. This helps the
                    supply chain to establish trust and allow documents to be
                    issued securely.
                  </p>
                  <br />
                  <h2>What is the TradeTrust Framework?</h2>
                  <p>
                    TradeTrust is an interoperability framework allowing
                    connectedness between governments and businesses, targeted
                    to enable seamless and efficient processes of exchanging
                    digital trade documents. The network allows increased
                    efficiencies by eliminating the need for repetitive checks,
                    reduces costs of physical documents, and facilitates the
                    creation of new services through interoperability,
                    visibility and control.
                  </p>
                  <br />
                  <h2>What technology is ConsenTrade using?</h2>
                  <p>
                    ConsenTrade is based on OpenAttestation technology which
                    leverages the functions of blockchain.
                  </p>
                  <br />
                  <h2>What is OpenAttestation Technology?</h2>
                  <p>
                    OpenAttestation Technology is an open-source framework to
                    authenticate documents using blockchain, allowing it to be
                    trackable and traceable while facilitating the transfer of
                    records. This allows the documents to be traced back to the
                    source of origin through the nature of cryptography. By
                    being cryptographically trustworthy, documents are also able
                  ...
                  <br />
                  <h2>
                    Why the need for blockchain technology in ConsenTrade?
                  </h2>
                  <p>
                    To enable a cost-effective, secure, efficient and reliable
                    system for tracking, recording and authenticating trade
                    documents. Blockchain provides an immutable audit trail,
                    time-stamped during every transaction.
                  </p>
                  <br />
                  <h2>
                    How does the platform identify authorized users before
                    granting access?
                  </h2>
                  <p>
                    Multi-factor authentication methods are implemented to
                    verify a user’s identity before granting access to the
                    platform. This enforces security for companies concerned
                    with risks of corporate impersonification by disallowing
                    unauthorized acts.
                  </p>
                  <br />
                  <h2>Are my documents safe when using ConsenTrade?</h2>
                  <p>
                  Yes! As we firmly believe in data privacy, 
                  your documents are encrypted with hashes and are not uploaded 
                  to our platform’s server, which makes the content unreadable. 
                  Only authorized users can view a document
                  </p>
                  <br />
                  <h2>Can the documents be tampered after issuance?</h2>
                  <p>
                  No, all documents issued by the platform are time-stamped which allow real-time status monitoring.
                  A tampered document will record a different timestamp from the original document; which will be validated and flagged by ConsenTrade.
                  </p>
                  <br />
                  <h2>Which file type can be verified?</h2>
                  <p>
                    Currently, the platform allows users to import a JSON file
                    to issue a document. Alternatively, users can manually input
                    information using existing templates which are provided on
                    the platform.
                  </p>
                  <br />
                  <h2>
                    Can I track the progress of the document flow during a
                    transaction?
                  </h2>
                  <p>
                  Yes! ConsenTrade’s dashboard provides an overview of the document's progress and status.
                  The system also automatically notifies the relevant parties on the updated status.
                  </p>
                  <br />
                  <h2>
                    Are the documents issued and signed on the platform
                    recognised by the law?
                  </h2>
                  <p>
                    Yes! Documents electronically issued and signed using the
                    TradeTrust framework satisfy legal requirements under the
                    Electronic Transaction Act in Singapore.
                  </p>
                </article>
              </div>
            </div>
